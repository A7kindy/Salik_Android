...
public final class LocationUtils {
     ...
     */
    public final static int		CONNECTION_FAILURE_RESOLUTION_REQUEST	= 1000;
    ...
    public static final int		FAST_CEILING_IN_SECONDS						= 120;
    ...
    // return
    // context.getString(R.string.latitude_longitude,currentLocation.getLatitude(),
